# Generated by Powerlevel10k configuration wizard on 2022-08-24 at 06:59 CEST.
...
() {
  ...
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=紐
  # Custom icon.

  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='紐'
  ...
  typeset -g POWERLEVEL9K_VCS_MAX_INDEX_SIZE_DIRTY=-3
...
POWERLEVEL9K_MY_PSN_LOGO_FOREGROUND=green
